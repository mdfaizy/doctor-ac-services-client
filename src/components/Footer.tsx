      ...
      <div className="container mx-auto px-4 py-14 grid gap-10 md:grid-cols-4">
        <div>
          ...
          <div className="mt-4 flex gap-3">
            ...
            <a href="#" aria-label="Facebook" className="grid place-items-center size-9 rounded-full bg-background/10 hover:bg-background/20"><FaFacebook /></a>
            <a href="#" aria-label="Instagram" className="grid place-items-center size-9 rounded-full bg-background/10 hover:bg-background/20"><FaInstagram /></a>
          </div>
        </div>
